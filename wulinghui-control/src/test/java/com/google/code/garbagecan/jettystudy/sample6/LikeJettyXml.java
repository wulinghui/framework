...
public class LikeJettyXml
{
    public static void main( String[] args ) throws Exception
    {
        ...
        String jettyHomeBuild = "C:/Users/Administrator/workspace/test/src/main/webapp/";
//        String jettyHomeBuild = "jetty-distribution/target/distribution";
        ...
        // === jetty-https.xml ===
        // SSL Context Factory
        SslContextFactory sslContextFactory = new SslContextFactory(); //new SslContextFactory.Server();
